            ...
            try {
                ...
                if ($this->request->getFile('foto_lantai')) {
                    $dataGambar->insert([
                        'id_permohonan' => (int)$permohonan->getInsertID(),
                        'jenis' => 'FOTO LANTAI',
                        'file' => base64_encode($this->request->getFile('foto_lantai'))
                    ]);
                }
                ...
                if ($this->request->getFile('foto_dinding')) {
                    $dataGambar->insert([
                        'id_permohonan' => (int)$permohonan->getInsertID(),
                        'jenis' => 'FOTO DINDING',
                        'file' => base64_encode($this->request->getFile('foto_dinding'))
                    ]);
                }
                ...
                if ($this->request->getFile('foto_atap')) {
                    $dataGambar->insert([
                        'id_permohonan' => (int)$permohonan->getInsertID(),
                        'jenis' => 'FOTO ATAP',
                        'file' => base64_encode($this->request->getFile('foto_atap'))
                    ]);
                }
            } catch (\Exception $e) {
            }
