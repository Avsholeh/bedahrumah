            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <ul class="nav nav-tabs">
                        <li class="nav-item">
                            <a class="nav-link <?= isset($edit['indikator']) ? 'active' : '' ?>" id="indikator-tab"
                               data-bs-toggle="tab"
                        ...
                        <li class="nav-item">
                            <a class="nav-link <?= isset($edit['atribut']) ? 'active' : '' ?>" id="atribut-tab"
                               data-bs-toggle="tab"
                                            ...
                                            <form action="<?= base_url('skoring/indikator/update') ?>" method="post">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" type="number" name="bobot"
                                                           placeholder="Bobot"
                                                           value="<?= isset($edit['indikator']) ? $edit['bobot'] : '' ?>">
                                    ...
                                    <div class="card rounded-0">
                                        <div class="card-body">
                                            <form action="<?= base_url('skoring/atribut/update') ?>" method="post">
                                                ...
                                                <input type="hidden" name="id"
                                                       value="<?= isset($edit['atribut']) ? $edit['id'] : '' ?>">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-select" name="id_indikator">
                                                        ...
                                                        <?php foreach ($indikator as $i): ?>
                                                            <option <?= (isset($edit['atribut']) && $edit['id_indikator'] == $i->id) ? 'selected' : '' ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" type="text" name="atribut"
                                                           ...
                                                           value="<?= isset($edit['atribut']) ? $edit['atribut'] : '' ?>">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" type="number" name="bobot"
                                                           ...
                                                           value="<?= isset($edit['atribut']) ? $edit['bobot'] : '' ?>">
                                                    <?php if ($error = $validation->getError('bobot')): ?>
                                                        <small class="text-danger"><?= $error ?></small>
                                                    <?php endif ?>
                                                </div>
